...
test_that("Multiple Stock Data", {
  testthat::expect_identical(getTicker(c("UZ7025770007", "UZ7015030008"), from = "2019-01-01", to = "2019-02-01")["symbol"] %>% unique(),
                             tibble(symbol = c("UZ7025770007", "UZ7015030008")))
})

test_that("Multiple Stock Data (symbol) - Character vector", {
  testthat::expect_identical(getTicker(c("KVTS", "UZTL"), from = "2024-01-01", to = "2024-02-01")["symbol"] %>% unique(),
                             tibble(symbol = c("UZ7025770007", "UZ7047110000")))
})

test_that("Multiple Stock Data (symbol) - List", {
  testthat::expect_identical(getTicker(list("KVTS", "UZTL"), from = "2024-01-01", to = "2024-02-01")["symbol"] %>% unique(),
                             tibble(symbol = c("UZ7025770007", "UZ7047110000")))
})
